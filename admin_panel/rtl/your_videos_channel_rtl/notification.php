							...
							<table id="table_channel" class="responsive-table display" cellspacing="0">
							  ...
							  <thead>
								  <tr>
								  	  ...
								  	  <th width="10%"><div align="right">No.</div></th>
								      <th width="50%"><div align="right">Message</div></th>
								      <th width="20%"><div align="right">Image</div></th>
							  ...
							  <tbody>
				                ...
				                <tr> 
									<td class="hide-column"><div align="right"><?php echo $rss_row['id'];?></div></td>
									<td><div align="right">
					            		<?php
						                    echo $i;
						                    $i++;
								   	...
								   	<td><div align="right"><?php echo $rss_row['message'];?></div></td>
								   	<td><div align="right">
								   	<?php
